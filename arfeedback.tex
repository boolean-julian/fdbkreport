		...
		\subsection*{Results of the Case Study}\label{ssec:results}
			...
			\begin{figure}[H]
				...
				\begin{subfigure}[t]{.49\textwidth}\centering
					\textbf{(B)}
				\end{subfigure}
				\caption{DUMMY: Appearances of the two finger rotation gesture and the pinch zoom gesture per task of the case study setup. }
				\label{fig:tfr_v_pz}
			\end{figure}
