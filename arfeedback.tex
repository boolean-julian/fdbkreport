	...
	\section*{Case Study}\label{sec:casestudy}
		...
		\subsection*{Results of the Case Study}\label{ssec:results}
			...
			\begin{center}
				...
				\end{tabular}
				\captionof{table}{p-values for statistical tests for the time needed to fulfill the 2nd task for the toaster prototype and the two finger rotation attempts.}
				\label{tab:pvalues}
			\end{center}
